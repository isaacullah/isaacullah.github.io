...
1. Human subsistence strategies are socio-ecological *attractors* in the phase space created by the ecological characteristics of the food stuffs being used, the general environmental productivity, and the technology, cultural adaptations, mobility strategy, size, and organization of the group. These variables are my "rule of hand" variables; there could certainly be others, but I think these are the most important. These attractors are *zones of relative stability* within the entirety of the phase space; they tend to *pull* groups into them.

2. Human subsistence *attractors* are separated by *repellors*, which are combinations of those previously listed variables that prove to be *unstable*. These repellors tend to *push* groups away from them.

3. The interaction of subsistence *attractors* and *repellors* is such that the socio-ecology of human groups tend to coalesce in patterns of relatively mutually exclusive subsistence "phenotypes" (i.e., distinct clustering as hunting/gathering, fishing, herding, extensive agriculture, intensive agriculture subsistence "types").
...
5. If this is all true, then there must have been some *internal* and/or *external* changes of the socio-ecological phase space in the centers of early agriculture, apparently sometime at the end of the Pleistocene. The interesting thing about this idea, is that it doesn't require *any one single driver* of this change. It could be climate, it could be environmental change (even human-induced!), it could be cultural changes, it could technology, it could be population, or it could be (most probably *is*) a combination of these things. And this combination can be *unique* to each center of early agriculture, but still subsumed under the same body of theory.
