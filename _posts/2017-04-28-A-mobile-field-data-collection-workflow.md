...
These first forays into digital data collection were back in 2012 and 2013, and we were among the first large-scale projects to go for an all-digital data recording pipeline. It wasn't without its hiccups, of course, but it worked remarkably well. My main issues with our approach (iOS devices and FileMaker GO forms) were 1) I hate Apple software products (personal preference), 2) most iOS devices (and most mobile devices in general) have terrible GPS chips, and 3) FileMaker GO wasn't as Geo-enabled as a GIS nerd like myself wanted it to be. So, at the same time as the Wadi Quseiba Project was deploying iPads, I also started exploring Android options in my other field projects. Over the last several years I've been perfecting my mobile collection pipeline, and that's what this post is going to be about. 
