...
<br><br>
 I plan to maintain and update this list over time. Please [e-mail me](mailto:isaaciullah@gmail.com) or leave a comment below if you have a piece of FOSS software you think should be on this list. Please provide examples of how your suggestion could be used in an academic context.
...
#### Spreadsheet
- [LibreOffice Calc](www.libreoffice.org) - A FOSS alternative for MSExcel. Slick, but limited in terms of statistical analysis and plots (as is MS Excel). [Linux, Mac, Windows]
